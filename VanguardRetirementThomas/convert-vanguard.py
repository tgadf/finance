...
def createVanguardRetirementThomasBalance(account = "VanguardRetirementThomas", debug = False):
...
def createVanguardRetirementThomasCSV(account = "VanguardRetirementThomas", debug = False):
    basedir = getBaseLocation()
...
def createVanguardRetirementThomasJSON(account = "VanguardRetirementThomas", debug = False):
    basedir = getBaseLocation()
...
def showVanguardRetirementThomasRecords(account = "VanguardRetirementThomas", debug = False):
    basedir = getBaseLocation()
    showSummary(account, basedir=basedir, debug=debug, showYear = False)
...
def run(debug = False):
    createVanguardRetirementThomasBalance(debug=debug)
    createVanguardRetirementThomasCSV(debug=debug)
    createVanguardRetirementThomasJSON(debug=debug)
...
if __name__ == "__main__":
    ...
    account="VanguardRetirementThomas"
    if args.run:
        createVanguardRetirementThomasCSV(account=account, debug=args.debug)
        createVanguardRetirementThomasJSON(account=account, debug=args.debug)
    if args.csv:
        createVanguardRetirementThomasCSV(account=account, debug=args.debug)
    if args.json:
        createVanguardRetirementThomasJSON(account=account, debug=args.debug)
    if args.show:
        showVanguardRetirementThomasRecords(account=account, debug=args.debug)