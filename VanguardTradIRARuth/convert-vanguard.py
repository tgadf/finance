...
def createVanguardTradIRARuthBalance(basedir = '/Users/tgadfort/Documents/finance',
                                  account = "VanguardTradIRARuth", debug = False):
...
def createVanguardTradIRARuthCSV(basedir = '/Users/tgadfort/Documents/finance',
                    account = "VanguardTradIRARuth", debug = False):
...
def createVanguardTradIRARuthJSON(basedir = '/Users/tgadfort/Documents/finance',
                    account = "VanguardTradIRARuth", debug = False):
    createJSON(account, basedir=basedir, debug=debug)
    showSummary(account, basedir=basedir, debug=debug, showYear = False)

def showVanguardTradIRARuthRecords(basedir = '/Users/tgadfort/Documents/finance',
                     account = "VanguardTradIRARuth", debug = False):
    showSummary(account, basedir=basedir, debug=debug, showYear = False)
    
def run(debug = False):
    createVanguardTradIRARuthCSV(debug=debug)
    createVanguardTradIRARuthJSON(debug=debug)
...
if __name__ == "__main__":
    ...
    account="VanguardTradIRARuth"
    if args.run:
        createVanguardTradIRARuthCSV(account=account, debug=args.debug)
        createVanguardTradIRARuthJSON(account=account, debug=args.debug)
    if args.csv:
        createVanguardTradIRARuthCSV(account=account, debug=args.debug)
    if args.json:
        createVanguardTradIRARuthJSON(account=account, debug=args.debug)
    if args.show:
        showVanguardTradIRARuthRecords(account=account, debug=args.debug)