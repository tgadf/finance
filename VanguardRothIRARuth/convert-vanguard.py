...
def createVanguardRothIRARuthBalance(basedir = '/Users/tgadfort/Documents/finance',
                                  account = "VanguardRothIRARuth", debug = False):
...
def createVanguardRothIRARuthCSV(basedir = '/Users/tgadfort/Documents/finance',
                    account = "VanguardRothIRARuth", debug = False):
...
def createVanguardRothIRARuthJSON(basedir = '/Users/tgadfort/Documents/finance',
                    account = "VanguardRothIRARuth", debug = False):
    createJSON(account, basedir=basedir, debug=debug)
    showSummary(account, basedir=basedir, debug=debug, showYear = False)

def showVanguardRothIRARuthRecords(basedir = '/Users/tgadfort/Documents/finance',
                     account = "VanguardRothIRARuth", debug = False):
    showSummary(account, basedir=basedir, debug=debug, showYear = False)
    
def run(debug = False):
    createVanguardRothIRARuthCSV(debug=debug)
    createVanguardRothIRARuthJSON(debug=debug)
...
if __name__ == "__main__":
    ...
    account="VanguardRothIRARuth"
    if args.run:
        createVanguardRothIRARuthCSV(account=account, debug=args.debug)
        createVanguardRothIRARuthJSON(account=account, debug=args.debug)
    if args.csv:
        createVanguardRothIRARuthCSV(account=account, debug=args.debug)
    if args.json:
        createVanguardRothIRARuthJSON(account=account, debug=args.debug)
    if args.show:
        showVanguardRothIRARuthRecords(account=account, debug=args.debug)