...
def createVanguardRothIRAThomasBalance(account = "VanguardRothIRAThomas", debug = False):
...
def createVanguardRothIRAThomasCSV(account = "VanguardRothIRAThomas", debug = False):
    basedir = getBaseLocation()
...
def createVanguardRothIRAThomasJSON(account = "VanguardRothIRAThomas", debug = False):
    basedir = getBaseLocation()
    createJSON(account, basedir=basedir, debug=debug)
    showSummary(account, basedir=basedir, debug=debug, showYear = False)


def showVanguardRothIRAThomasRecords(account = "VanguardRothIRAThomas", debug = False):
    basedir = getBaseLocation()    
    showSummary(account, basedir=basedir, debug=debug, showYear = False)
    
    
def run(debug = False):
    createVanguardRothIRAThomasBalance(debug=debug)
    createVanguardRothIRAThomasCSV(debug=debug)
    createVanguardRothIRAThomasJSON(debug=debug)
...
if __name__ == "__main__":
    ...
    account="VanguardRothIRAThomas"
    if args.run:
        createVanguardRothIRAThomasCSV(account=account, debug=args.debug)
        createVanguardRothIRAThomasJSON(account=account, debug=args.debug)
    if args.csv:
        createVanguardRothIRAThomasCSV(account=account, debug=args.debug)
    if args.json:
        createVanguardRothIRAThomasJSON(account=account, debug=args.debug)
    if args.show:
        showVanguardRothIRAThomasRecords(account=account, debug=args.debug)